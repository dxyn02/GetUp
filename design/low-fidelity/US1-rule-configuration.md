...
- 요일, 100m·250m·500m·1km 반경, 저장 장소와 제한 앱 선택
...
- 요일은 최소 1개를 선택해야 한다.
- 반경 slider는 `100m`, `250m`, `500m`, `1km`의 네 단계에 snap한다.
...
| `2026-08-26` | 사용자·`Codex` | 반경 slider 값만 100m·250m·500m·1km 네 단계로 대체하고 기존 레이아웃은 유지함 | 반경 선택지 변경 요청 |
